...
RSpec.describe Bump::FileUpdaters::Cocoa::CocoaPods do
  ...
  let(:podfile) do
    Bump::DependencyFile.new(content: podfile_body, name: "Podfile")
  end
  let(:podfile_body) { fixture("cocoa", "podfiles", "version_specified") }
  let(:lockfile) do
    Bump::DependencyFile.new(content: lockfile_body, name: "Podfile.lock")
  end
